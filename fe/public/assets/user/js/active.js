  ...
  $(document).on("ready", function () {
    ...
    $(function () {
      $("#slider-range").slider({
        range: true,
        min: 0,
        max: 5000000, // Giá trị max được thay đổi thành 5 triệu (5,000,000)
        step: 100000, // Bước tăng được thay đổi thành 0.1
        values: [1200000, 2500000], // Giá trị ban đầu được chọn ứng với 1.2 triệu và 2.5 triệu
